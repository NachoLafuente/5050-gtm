...
> Adapted from [EveryInc/charlie-cfo-skill](https://github.com/EveryInc/charlie-cfo-skill) (MIT, © 2026 Every).
>
> ⚠️ These are heuristics, not advice. Benchmarks vary by industry, stage, geography, and business model.
...
Bootstrapped companies typically achieve 40-70% higher RPE than VC-backed at the same stage.
...
```
Negotiate highest DPO possible while maintaining vendor relationships.
...
Median SaaS: ~34%. Top quartile bootstrapped: 50%+.
...
Track separately for revenue (target 5-10% MAPE), expenses (10-15%), cash flow (10-15%).
